...
public class ParticipantType implements Comparable{
    ...
    public int compareTo(Object o) {
        try{
            int comparedSpeed = ((ParticipantType)o).getBaseSpeed().intValue();
            return comparedSpeed - this.getBaseSpeed().intValue();
        }catch (Exception ex){
